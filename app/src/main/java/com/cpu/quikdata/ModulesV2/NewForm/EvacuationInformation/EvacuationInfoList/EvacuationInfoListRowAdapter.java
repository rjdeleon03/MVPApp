...
public class EvacuationInfoListRowAdapter extends TemplateEnumDataRowAdapter<EvacuationItem> {

    public EvacuationInfoListRowAdapter(ITemplateEnumDataFragment enumDataFragment, ITemplateEnumDataManager enumDataManager) {
        super(enumDataFragment, enumDataManager);
    }

    @Override
    protected TemplateEnumDataRowViewModel initRowViewModel(int position) {
        EvacuationInfoListRowViewModel rowViewModel = new EvacuationInfoListRowViewModel(null, position);

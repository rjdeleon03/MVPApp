...
public class CalamityDetailsViewModel extends TemplateQuestionViewModel<INewFormActivity, GeneralInformation> {
    ...
    public void onDataReceived(GeneralInformation data) {
        ...
        mQuestions.add(new QuestionItemModelString("Calamity Type: ", mCalamityDetails.getCalamityType()));
        mQuestions.add(new QuestionItemModelString("Event Description: ", mCalamityDetails.getEventDesc()));
        mQuestions.add(new QuestionItemModelString("Area Description: ", mCalamityDetails.getAreaDesc()));
    }
}

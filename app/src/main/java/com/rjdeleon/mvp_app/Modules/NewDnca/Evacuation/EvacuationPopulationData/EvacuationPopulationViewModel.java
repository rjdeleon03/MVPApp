...
import com.rjdeleon.mvp_app.Modules.NewDnca.Evacuation.EvacuationEnumBaseViewModel;
...
public class EvacuationPopulationViewModel extends EvacuationEnumBaseViewModel implements EvacuationPopulationRepositoryManager {
     ...
     * @param enumClass
     */
    protected EvacuationPopulationViewModel(Context context, EvacuationRepositoryManager evacuationRepositoryManager, @Nullable Class<? extends Enum> enumClass) {
        super(context, evacuationRepositoryManager, enumClass);
